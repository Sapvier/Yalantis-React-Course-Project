...
import "./SideBar.css";
import {fetchItems, fetchMyProducts, fetchOrigins} from "../../utils/services/api/fetch";
...
function MyProductsSideBar () {
    ...
    const clickHandler = () => {
        ...
        fetchMyProducts(pagination.currentPage, pagination.perPage, filter).then(r => {
...
export default MyProductsSideBar;